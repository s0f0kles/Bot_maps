...
- **Выбор цвета маркеров**: Пользователи могут выбирать цвет маркеров для отображения городов на карте. Доступные цвета: красный, синий,зеленый, желтый, фиолетовый и оранжевый.
- **Заливка континентов и океанов**: Карта включает заливку континентов и океанов для лучшей визуализации.
- **Географические объекты**: На карте отображаются береговые линии, границы стран, реки и озера для лучшего контекста.
...
- `/set_color <color>` - Выбрать цвет маркеров (например, red, blue, green).
